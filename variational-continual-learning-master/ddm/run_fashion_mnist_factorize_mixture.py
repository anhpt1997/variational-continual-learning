...
import sys
sys.path.extend(['alg/'])
import vcl_fashion_mnist_factorize as vcl
import coreset
...
if len(sys.argv) != 7:
	print("run_split_gauss_mixture.py num_gauss num_train no_epochs tau seed dimfac")
else:
	...
	data_gen = pickle.load(open("data_fashion_mnist", "rb"))
	np.random.seed(1)
