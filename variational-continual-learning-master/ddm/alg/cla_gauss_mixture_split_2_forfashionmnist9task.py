...
class MFVI_NN(Cla_NN):
    ...
    def assign_optimizer(self, learning_rate=0.001):
        ...
        train_step_share = tf.train.AdamOptimizer(self.learing_rate_share / no_task).minimize(self.cost , var_list = list_weight_trainable_share)
