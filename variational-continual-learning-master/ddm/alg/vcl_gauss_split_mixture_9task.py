...
import time
from cla_gauss_mixture_split_2 import Vanilla_NN , MFVI_NN
import os , sys
...
def create_path_file_result(num_gauss , num_train , tau , sd):
    root = "result_mixture_split_mnist_version_9task"
...
def create_list_seed(num_gauss , sd ):
    temp = num_gauss -1 
    list_seed = list(range(0 , temp))
    list_seed = [int(-t) for t in list_seed]
